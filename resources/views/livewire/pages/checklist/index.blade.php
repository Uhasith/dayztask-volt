...
<div class="w-full mx-auto p-5 lg:px-10 lg:py-5">
    @foreach ($checkList as $item)
        <div class="flex w-full p-4 flex-col rounded-lg bg-white shadow-sm border border-slate-200 my-6 cursor-pointer dark:bg-gray-800 dark:border-gray-700" wire:key="{{ 'checklist-item-' . $item->uuid }}">
