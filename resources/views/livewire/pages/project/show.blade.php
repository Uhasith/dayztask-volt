<div class="w-full mx-auto p-5 lg:px-10 lg:py-5" x-data>
    <div class="grid grid-cols-12 items-center">
        ...
        <div class="col-span-12 md:col-span-4 mt-4 md:mt-0 flex items-center justify-center gap-5">
            ...
            <x-wui-mini-button info icon="document-text" x-tooltip.placement.bottom.raw="Notes" />
            <x-wui-mini-button primary icon="plus" x-tooltip.placement.bottom.raw="New Task"  />
        </div>
    </div>
</div>
