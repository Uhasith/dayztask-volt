<div>
    <div class="relative">
        <div class="absolute z-10 block top-3 right-4 cursor-pointer" wire:click="$dispatch('openProjectEditDrawer', { id: {{ $project['id'] }} })">
                ...
                text-[18px] font-semibold leading-10 tracking-tight transition-colors duration-300 ease-in-out">
                    <div
                        ...
                        <h5 class="mb-2 text-xl max-w-60 font-bold tracking-tight text-gray-900 dark:text-white truncate"
                           style="font-color: {{ !empty($project['font_color']) ? $project['font_color'] : '#0000' }}">
